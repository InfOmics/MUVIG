...
data.dir    = "../../data/genotyping/Integrated_View_Datscan"
results.dir = "../../results/integratedView/DaTSCAN"

gwas = read.table(paste0(data.dir,"/Grace_DATScan.assoc.linear"), header = T)

out.fn    = paste0(results.dir,"/Manhattan_datscan_Grace.png")
out.fn.qq = paste0(results.dir,"/QQ_datscan_Grace.png")
